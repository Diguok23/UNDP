  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Add Country</h1>
          <p className="mt-1 text-muted-foreground">
            Create a new country program page
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the country name and region
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Detailed overview of UNEDF's work in this country..."
                rows={5}
              />
            </div>
          </CardContent>
            ...
            {formData.key_results.map((result, index) => (
              <div key={index} className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., 2.5 million people with improved livelihoods"
                />
              </div>
            ))}
          </CardContent>
